...
and makes the whole set consistent (user decisions 2026-08-15):
  ...
  * generation lineations recoded: L1-L5 (which wrongly cloned the LNS
    ...
    a Century Gothic 'L1'..'L5' label baked as path outlines (no font
    needed at render time) - in both renderer and FieldNotebookCodes;
...
# Regular Century Gothic "L1".."L5" outlines (extracted from GOTHIC.TTF
# via matplotlib TextPath, y-down, height 100) so the generation labels
# need no font at render time.
FONT_LABELS = {
    "L1": ("M12.2,0.0 L22.2,0.0 L22.2,90.3 L60.6,90.3 L60.6,100.0 L12.2,100.0 L12.2,0.0 Z M90.1,0.0 L109.7,0.0 L109.7,100.0 L99.8,100.0 L99.8,9.8 L84.1,9.8 L90.1,0.0 Z", 109.7),
    "L2": ("M11.9,2.5 L21.7,2.5 L21.7,90.6 L59.2,90.6 L59.2,100.0 L11.9,100.0 L11.9,2.5 Z M78.4,33.0 L69.1,33.0 Q69.5,18.6 78.7,9.3 Q88.0,0.0 101.6,0.0 Q115.0,0.0 123.4,8.7 Q131.7,17.4 131.7,29.2 Q131.7,37.5 127.7,44.7 Q123.7,52.0 112.2,64.4 L88.0,90.6 L133.0,90.6 L133.0,100.0 L66.8,100.0 L104.0,59.7 Q115.4,47.6 118.8,41.8 Q122.2,35.9 122.2,29.4 Q122.2,21.2 116.1,15.2 Q109.9,9.3 101.0,9.3 Q91.7,9.3 85.5,15.5 Q79.3,21.7 78.4,33.0 Z", 133.0),
    "L3": ("M11.6,2.4 L21.2,2.4 L21.2,88.4 L57.7,88.4 L57.7,97.6 L11.6,97.6 L11.6,2.4 Z M78.8,24.5 L69.0,24.5 Q71.7,12.7 79.2,6.4 Q86.7,0.0 96.9,0.0 Q104.4,0.0 110.8,3.4 Q117.3,6.8 120.8,12.6 Q124.3,18.3 124.3,24.6 Q124.3,36.9 112.1,44.1 Q119.0,46.9 123.3,52.2 Q129.6,59.8 129.6,69.2 Q129.6,77.3 125.3,84.6 Q121.0,92.0 113.6,96.0 Q106.3,100.0 97.1,100.0 Q84.8,100.0 76.6,92.9 Q68.4,85.8 65.9,72.1 L75.2,72.1 Q77.7,81.4 82.3,85.5 Q88.1,90.7 97.3,90.7 Q107.6,90.7 113.9,84.5 Q120.2,78.3 120.2,70.0 Q120.2,64.4 117.0,59.6 Q113.9,54.7 108.6,52.2 Q103.3,49.8 92.3,49.2 L92.3,40.5 Q98.8,40.5 104.2,38.2 Q109.6,35.9 112.0,32.3 Q114.4,28.7 114.4,24.5 Q114.4,18.3 109.5,13.8 Q104.5,9.3 96.9,9.3 Q90.8,9.3 86.3,12.7 Q81.9,16.2 78.8,24.5 Z", 129.6),
    "L4": ("M11.9,2.5 L21.7,2.5 L21.7,90.6 L59.2,90.6 L59.2,100.0 L11.9,100.0 L11.9,2.5 Z M120.5,0.0 L122.5,0.0 L122.5,68.0 L134.3,68.0 L134.3,77.3 L122.5,77.3 L122.5,100.0 L112.8,100.0 L112.8,77.3 L66.2,77.3 L120.5,0.0 Z M112.8,68.0 L112.8,27.3 L84.1,68.0 L112.8,68.0 Z", 134.3),
    "L5": ("M11.9,0.0 L21.7,0.0 L21.7,88.1 L59.2,88.1 L59.2,97.5 L11.9,97.5 L11.9,0.0 Z M129.5,0.0 L129.5,9.3 L94.7,9.3 L89.9,35.9 Q96.3,34.0 101.4,34.0 Q114.7,34.0 123.4,42.9 Q132.0,51.9 132.0,65.8 Q132.0,75.4 127.6,83.4 Q123.1,91.4 115.5,95.7 Q107.9,100.0 98.0,100.0 Q86.1,100.0 78.0,92.7 Q69.8,85.5 68.2,73.9 L78.2,73.9 Q79.4,79.6 82.1,83.1 Q84.7,86.6 89.2,88.8 Q93.7,90.9 98.6,90.9 Q108.2,90.9 115.1,83.6 Q122.0,76.3 122.0,65.4 Q122.0,55.5 115.8,49.3 Q109.5,43.2 99.1,43.2 Q90.5,43.2 78.2,48.4 L87.3,0.0 L129.5,0.0 Z", 132.0),
}
